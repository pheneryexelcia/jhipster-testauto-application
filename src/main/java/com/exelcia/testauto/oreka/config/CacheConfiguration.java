...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.exelcia.testauto.oreka.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.exelcia.testauto.oreka.repository.UserRepository.USERS_BY_EMAIL_CACHE);
